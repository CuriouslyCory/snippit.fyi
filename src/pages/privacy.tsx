...
export const Privacy: NextPage = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to CuriouslyCory, PO BOX 1325, Queen Creek,
            AZ 85142.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Snipit, accessible from{" "}
            <a
              href="https://snipit.fyi"
      ...
      <ul>
        <li>By email: support@snipit.fyi</li>
      </ul>
    </>
  );
};
